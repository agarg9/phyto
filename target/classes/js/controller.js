...
app.controller("newApplController", function ($scope,$http,$rootScope,share) {
	/*
...
//		console.log("called :"+share.getShare());
	...
	$rootScope.openApplication = function(){
		appform = share.getShare();
	}
